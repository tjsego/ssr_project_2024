...
_render_231129_0_column_width = 3.0
_render_231129_0_row_height = 2.0
_render_231129_0_ecf_sampling_fit_width = 6.0
_render_231129_0_ecf_sampling_fit_height = 4.0


def _render_231129_0_generate_render_hooks(num_names: int, num_trials: int):
    def _render_hook_generated_deterministic(fig, ax):
        fig.set_size_inches(_render_231129_0_column_width * num_names, _render_231129_0_row_height)

    def _render_hook_generated_distributions(fig, ax):
        fig.set_size_inches(_render_231129_0_column_width * num_names, _render_231129_0_row_height * num_trials)

    def _render_hook_generated_ecf(fig, ax):
        from matplotlib.legend import Legend

        fig.set_size_inches(_render_231129_0_column_width * num_names, _render_231129_0_row_height * 2)
    ...
    def _render_hook_generated_ks_sampling(fig, ax):
        fig.set_size_inches(_render_231129_0_row_height * 4, _render_231129_0_row_height * num_trials)

    def _render_hook_generated_ks_sampling_fits(fig, ax):
        fig.set_size_inches(_render_231129_0_ecf_sampling_fit_width, _render_231129_0_ecf_sampling_fit_height)
...
_render_231129_0_render_hooks = {
    'tellurium_ex': _render_231129_0_generate_render_hooks(4, 7),
    'tellurium_ex1': _render_231129_0_generate_render_hooks(4, 7)
}


def _render_231129_0(basename: str):
    ...
    render_hooks = _render_231129_0_render_hooks[basename] if basename in _render_231129_0_render_hooks.keys() else None
    render.render(test=test, render_dir=os.path.join(results_dir, 'renders'), prefix=basename, render_hooks=render_hooks)


def render_231129_0():
    basenames = ['tellurium_ex', 
                 'tellurium_ex1']
    workers = []
    for bn in basenames:
        workers.append(mp.Process(target=_render_231129_0, args=(bn,)))
